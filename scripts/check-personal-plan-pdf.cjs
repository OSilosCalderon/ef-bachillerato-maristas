...
const bytes = loaded.exports.buildPersonalPlanPdf({
  ...
  sections: [
    ...
    { title: "2. Objetivos y dosis general", lines: ["Objetivo principal: mejorar la resistencia de forma progresiva.", "4 semanas - 3 sesiones/semana - 55 min por sesión"] },
    { title: "3. Calendario, tareas y cargas", lines: sessions },
    { title: "4. Progresión, recuperación y evaluación", lines: ["Progresión: aumentar una variable cada semana.", "Recuperación: alternar sesiones y cuidar el sueño."] },
