...
export default function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center px-5 py-10">
      <section className="card relative w-full max-w-md overflow-hidden p-7 sm:p-9">
        ...
        <div className="relative">
          ...
          <p className="course-motto mt-4 text-4xl">¿Te imaginas?</p>
          <p className="mt-3 text-sm font-semibold text-[#8b5e3c]">Tu curso. Tu evolución. Tu aprendizaje.</p>
